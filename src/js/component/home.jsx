	...
	return (
		<div>
			...
			<div className="cards-container">
				...
				<Card title="Card Title 4" text="Further example text to build on the card title." imageUrl="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZfG7cDsHqqqvETgyrgmzOP1DZJya_umxM0fjAYXDhLpiNJe9YEaNd_wT-alLqGB6QBPg&usqp=CAU"/>
			</div>
			<Footer/>
		</div>
	);
